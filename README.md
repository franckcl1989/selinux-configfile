...
100% safe Rust parser and writer for `/etc/selinux/config` with format-preserving writes, type-safe API, and atomic file updates. Zero dependencies beyond `std`.
